...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	$mysqli->postReactions()->insertReactionOfPost($data["ReactionID"], $data["Username"], $data["post-id"]);
	...
	$port["reazione-attiva"] = $mysqli->postReactions()->getPostReactionByPostIdAndUsername($_GET["post-id"]);
