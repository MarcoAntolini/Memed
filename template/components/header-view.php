<div class="header container-fluid d-flex justify-content-center color-main p-2 fixed-top">
    <div class="row gap-2 align-items-end">
        ...
        <div class="col">
            <form id="search-form" action="" name="search" method="post">
        ...
        <div class="col">
            <button class="btn">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-align-center" width="44" height="44" viewBox="0 0 24 24"
